    ...
    <div>
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="周报模板" name="weekly">
                ...
                <markdown-editor v-if="weeklyEdit" v-model="resultTemplate.weeklyTemplate.template" ref="markdownEditor" :configs="configs"></markdown-editor>
            ...
            <el-tab-pane label="总结模板" name="summary">
                ...
                <markdown-editor v-if="summaryEdit" v-model="resultTemplate.summaryTemplate.template" ref="markdownEditor" :configs="configs"></markdown-editor>
                <vue-markdown v-else :source="resultTemplate.summaryTemplate.template" v-highlight></vue-markdown>
            </el-tab-pane>
            <el-button @click="btnActive()" class="config-btn">{{btnText}}</el-button>
...
export default {
    ...
    methods: {
        ...
        saveConfig(type) {
            ...
            saveReportTemplate(res).then((res) => {
